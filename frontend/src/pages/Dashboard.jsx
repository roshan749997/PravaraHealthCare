        ...
        <div className="flex w-full flex-col gap-6 sm:gap-8 px-3 py-4 sm:px-6 lg:px-8 xl:px-12">
              ...
              return (
                ...
                >
                  ...
                  <div className="relative z-10 transition-transform duration-300">
                    ...
                    <h2 
                      className="text-xs sm:text-sm font-medium text-black mb-2 transition-opacity duration-300"
          ...
          <section className="grid gap-4 sm:gap-6 grid-cols-1 lg:grid-cols-[1fr_1fr]">
            <article className="rounded-lg border border-gray-200 bg-white p-3 sm:p-4 lg:p-4" style={{ boxShadow: '0 20px 25px -5px rgba(0, 0, 0, 0.3), 0 10px 10px -5px rgba(0, 0, 0, 0.2), 0 0 0 1px rgba(0, 0, 0, 0.05)' }}>
              <div className="mb-2 sm:mb-3 lg:mb-3">
                <h3 className="text-xs sm:text-sm font-bold tracking-[0.05em] text-black mb-1" style={{ fontFamily: "'Inter', 'system-ui', '-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Roboto', 'sans-serif'" }}>Revenue Distribution</h3>
            ...
            <article className="rounded-lg border border-gray-200 bg-white p-3 sm:p-4 lg:p-4" style={{ boxShadow: '0 20px 25px -5px rgba(0, 0, 0, 0.3), 0 10px 10px -5px rgba(0, 0, 0, 0.2), 0 0 0 1px rgba(0, 0, 0, 0.05)' }}>
              <div className="mb-2 sm:mb-3 lg:mb-3">
                <h3 className="text-xs sm:text-sm font-bold tracking-[0.05em] text-black mb-1" style={{ fontFamily: "'Inter', 'system-ui', '-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Roboto', 'sans-serif'" }}>Employee Distribution</h3>
          ...
          <section className="grid gap-4 sm:gap-6 grid-cols-1 lg:grid-cols-[2fr_1fr]">
            <article className="rounded-lg border border-gray-200 bg-white p-4 sm:p-5 lg:p-6" style={{ boxShadow: '0 20px 25px -5px rgba(0, 0, 0, 0.3), 0 10px 10px -5px rgba(0, 0, 0, 0.2), 0 0 0 1px rgba(0, 0, 0, 0.05)' }}>
              <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
                <div className="flex-1 min-w-0">
                  <p className="text-xs sm:text-sm font-bold tracking-[0.05em] text-black" style={{ fontFamily: "'Inter', 'system-ui', '-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Roboto', 'sans-serif'" }}>Total Sales</p>
            ...
            <article className="rounded-lg border border-gray-200 bg-white p-4 sm:p-5 lg:p-6" style={{ boxShadow: '0 20px 25px -5px rgba(0, 0, 0, 0.3), 0 10px 10px -5px rgba(0, 0, 0, 0.2), 0 0 0 1px rgba(0, 0, 0, 0.05)' }}>
              <p className="text-xs sm:text-sm font-bold tracking-[0.05em] text-black" style={{ fontFamily: "'Inter', 'system-ui', '-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Roboto', 'sans-serif'" }}>Summary</p>
          ...
          <section className="grid gap-4 sm:gap-6 grid-cols-1 lg:grid-cols-[1.1fr_1fr]">
            ...
            <article className="rounded-lg border border-gray-200 bg-white p-4 sm:p-5 lg:p-6" style={{ boxShadow: '0 20px 25px -5px rgba(0, 0, 0, 0.3), 0 10px 10px -5px rgba(0, 0, 0, 0.2), 0 0 0 1px rgba(0, 0, 0, 0.05)' }}>
              <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
                <div className="flex-1 min-w-0">
                  <p className="text-xs sm:text-sm font-bold tracking-[0.05em] text-black" style={{ fontFamily: "'Inter', 'system-ui', '-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Roboto', 'sans-serif'" }}>Sales Funnel</p>
            ...
            <article className="rounded-lg border border-gray-200 bg-white p-3 sm:p-4 lg:p-6" style={{ boxShadow: '0 20px 25px -5px rgba(0, 0, 0, 0.3), 0 10px 10px -5px rgba(0, 0, 0, 0.2), 0 0 0 1px rgba(0, 0, 0, 0.05)' }}>
              <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
                <div className="flex-1 min-w-0">
                  <p className="text-xs sm:text-sm font-bold tracking-[0.05em] text-black break-words" style={{ fontFamily: "'Inter', 'system-ui', '-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Roboto', 'sans-serif'" }}>Revenue % Variance to Budget by Month and Executive</p>
          ...
          <section className="grid gap-4 sm:gap-6 grid-cols-1 lg:grid-cols-[2fr_1fr]">
            <article className="rounded-lg border border-gray-200 bg-white p-4 sm:p-5 lg:p-6" style={{ boxShadow: '0 20px 25px -5px rgba(0, 0, 0, 0.3), 0 10px 10px -5px rgba(0, 0, 0, 0.2), 0 0 0 1px rgba(0, 0, 0, 0.05)' }}>
              <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
                <div className="flex-1 min-w-0">
                  <p className="text-xs sm:text-sm font-bold tracking-[0.05em] text-black" style={{ fontFamily: "'Inter', 'system-ui', '-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Roboto', 'sans-serif'" }}>Customer Retention</p>
                  <p className="text-[0.65rem] sm:text-xs text-gray-500">Jan 1, 2023 – Jun 30, 2023</p>
                </div>
                <span className="mt-2 sm:mt-3 rounded-full border border-blue-200 bg-blue-50 px-2 py-1 sm:px-3 sm:py-1 text-[0.65rem] sm:text-xs font-semibold text-blue-700 whitespace-nowrap">
                  87% avg retention
            ...
            <article className="flex flex-col gap-3 sm:gap-4 rounded-lg border border-gray-200 bg-white p-4 sm:p-5 lg:p-6" style={{ boxShadow: '0 20px 25px -5px rgba(0, 0, 0, 0.3), 0 10px 10px -5px rgba(0, 0, 0, 0.2), 0 0 0 1px rgba(0, 0, 0, 0.05)' }}>
              <div className="flex items-start sm:items-center justify-between gap-2">
                <div className="flex-1 min-w-0">
                  <p className="text-xs sm:text-sm font-bold tracking-[0.05em] text-black" style={{ fontFamily: "'Inter', 'system-ui', '-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Roboto', 'sans-serif'" }}>Action Center</p>
