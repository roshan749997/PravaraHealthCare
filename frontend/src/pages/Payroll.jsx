      ...
      <main className="mx-auto flex w-full max-w-7xl grow flex-col gap-8 px-4 py-8 sm:gap-10 sm:px-6 sm:py-10">
        ...
        <section className="grid gap-4 lg:grid-cols-2">
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-4 sm:p-6" style={{ boxShadow: '0 20px 25px -5px rgba(0, 0, 0, 0.3), 0 10px 10px -5px rgba(0, 0, 0, 0.2), 0 0 0 1px rgba(0, 0, 0, 0.05)' }}>
            <h3 className="text-base font-bold  tracking-[0.05em] text-black mb-4">Department Salary Distribution</h3>
            <div className="h-64">
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-4 sm:p-6" style={{ boxShadow: '0 20px 25px -5px rgba(0, 0, 0, 0.3), 0 10px 10px -5px rgba(0, 0, 0, 0.2), 0 0 0 1px rgba(0, 0, 0, 0.05)' }}>
            <h3 className="text-sm sm:text-base font-bold  tracking-[0.05em] text-black mb-3 sm:mb-4">Salary Range Distribution</h3>
